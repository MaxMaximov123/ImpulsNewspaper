      ...
      async loadNewPosts() {
        ...
        for (let index=0;index<requestResults.length;index++) {
            ...
            if (obj.sourceKey !== 'ABOUT_PROJECT') {
              ...
              // obj.images = [];
              // obj.text = [
              //   `<h4 style="">База данных</h4>
              //   <div style="margin-top: 5%; margin-botton: 5%; text-align: left">
              //     <div style="text-align: justify;">
              //       <h6>
              //       <img src="https://tinylinks.ru/twqep" style="margin-bottom: -5px; width: 30px; margin-right: -5px">
              //       <b>PostgreSQL</b> — свободная объектно-реляционная система управления базами данных (СУБД).
              //       </h6>
              //     </div>
              //     <br>
              //     <h6><b>Используемые таблицы:</b>
              //       <br>
